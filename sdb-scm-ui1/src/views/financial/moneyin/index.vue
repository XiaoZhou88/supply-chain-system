  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      ...
      <div class="table-operations">
        <a-button type="primary" @click="$refs.createForm.handleAdd()" v-hasPermi="['financial:moneyin:add']">
          <a-icon type="plus" />新增
        </a-button>
        <a-button type="primary" :disabled="single" @click="$refs.createForm.handleUpdate(undefined, ids)" v-hasPermi="['financial:moneyin:edit']">
          <a-icon type="edit" />修改
        </a-button>
        <a-button type="danger" :disabled="multiple" @click="handleDelete" v-hasPermi="['financial:moneyin:remove']">
          <a-icon type="delete" />删除
        </a-button>
        <a-button type="primary" @click="handleExport" v-hasPermi="['financial:moneyin:export']">
      ...
      <a-table
        ...
        <span slot="operation" slot-scope="text, record">
          <a-divider type="vertical" v-hasPermi="['financial:moneyin:edit']" />
          <a @click="$refs.createForm.handleUpdate(record, undefined)" v-hasPermi="['financial:moneyin:edit']">
            <a-icon type="edit" />修改
          </a>
          <a-divider type="vertical" v-hasPermi="['financial:moneyin:remove']" />
          <a @click="handleDelete(record)" v-hasPermi="['financial:moneyin:remove']">
            <a-icon type="delete" />删除
          </a>
        </span>
      </a-table>
...
<script>
import { listMoneyin, delMoneyin, exportMoneyin } from '@/api/financial/moneyin'
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      listMoneyin(this.queryParam).then(response => {
    ...
    handleDelete (row) {
      ...
      this.$confirm({
        ...
        onOk () {
          return delMoneyin(accountHeadIds)
            .then(() => {
              that.onSelectChange([], [])
              that.getList()
    ...
    handleExport () {
      ...
      this.$confirm({
        ...
        onOk () {
          return exportMoneyin(that.queryParam)
            .then(response => {
