<template>
  <a-drawer width="35%" :label-col="4" :wrapper-col="14" :visible="open" @close="onClose">
    ...
    <a-form-model ref="form" :model="form" :rules="rules">
      <a-form-model-item label="客户名称" prop="supplierName" >
        <a-input v-model="form.supplierName" placeholder="请输入客户名称" />
      </a-form-model-item>
...
<!--      <a-form-model-item  label="是否系统自带 0==系统 1==非系统" prop="isystem" >-->
<!--        <a-input v-model="form.isystem" placeholder="请输入是否系统自带 0==系统 1==非系统" />-->
<!--      </a-form-model-item>-->
      <a-form-model-item v-show="false" label="类型" prop="type" >
...
<script>
import { getCustomer, addCustomer, updateCustomer } from '@/api/base/supplier'
...
export default {
  ...
  methods: {
    ...
    handleUpdate (row, ids) {
      ...
      getCustomer(supplierId).then(response => {
