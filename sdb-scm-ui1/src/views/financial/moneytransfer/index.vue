  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      ...
      <div class="table-operations">
        <a-button type="primary" @click="$refs.createForm.handleAdd()" v-hasPermi="['financial:moneytransfer:add']">
          <a-icon type="plus" />新增
        </a-button>
        <a-button type="primary" :disabled="single" @click="$refs.createForm.handleUpdate(undefined, ids)" v-hasPermi="['financial:moneytransfer:edit']">
          <a-icon type="edit" />修改
        </a-button>
        <a-button type="danger" :disabled="multiple" @click="handleDelete" v-hasPermi="['financial:moneytransfer:remove']">
          <a-icon type="delete" />删除
        </a-button>
        <a-button type="primary" @click="handleExport" v-hasPermi="['financial:moneytransfer:export']">
      ...
      <a-table
        ...
        <span slot="operation" slot-scope="text, record">
          <a-divider type="vertical" v-hasPermi="['financial:moneytransfer:edit']" />
          <a @click="$refs.createForm.handleUpdate(record, undefined)" v-hasPermi="['financial:moneytransfer:edit']">
            <a-icon type="edit" />修改
          </a>
          <a-divider type="vertical" v-hasPermi="['financial:moneytransfer:remove']" />
          <a @click="handleDelete(record)" v-hasPermi="['financial:moneytransfer:remove']">
            <a-icon type="delete" />删除
          </a>
        </span>
      </a-table>
...
<script>
import { listMoneytransfer, delMoneytransfer, exportMoneytransfer } from '@/api/financial/moneytransfer'
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      listMoneytransfer(this.queryParam).then(response => {
    ...
    handleDelete (row) {
      ...
      this.$confirm({
        ...
        onOk () {
          return delMoneytransfer(accountHeadIds)
            .then(() => {
              that.onSelectChange([], [])
              that.getList()
    ...
    handleExport () {
      ...
      this.$confirm({
        ...
        onOk () {
          return exportMoneytransfer(that.queryParam)
            .then(response => {
