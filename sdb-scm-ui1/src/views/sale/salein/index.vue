  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      ...
      <div class="table-operations">
        <a-button type="primary" @click="$refs.createForm.handleAdd()" v-hasPermi="['sale:salein:add']">
          <a-icon type="plus" />新增
        </a-button>
        <a-button type="primary" :disabled="single" @click="$refs.createForm.handleUpdate(undefined, ids)" v-hasPermi="['sale:salein:edit']">
          <a-icon type="edit" />修改
        </a-button>
        <a-button type="danger" :disabled="multiple" @click="handleDelete" v-hasPermi="['sale:salein:remove']">
          <a-icon type="delete" />删除
        </a-button>
        <a-button type="primary" @click="handleExport" v-hasPermi="['sale:salein:export']">
      ...
      <a-table
        ...
        <span slot="operation" slot-scope="text, record">
          <a-divider type="vertical" v-hasPermi="['sale:salein:edit']" />
          <a @click="$refs.createForm.handleUpdate(record, undefined)" v-hasPermi="['sale:salein:edit']">
            <a-icon type="edit" />修改
          </a>
          <a-divider type="vertical" v-hasPermi="['sale:salein:remove']" />
          <a @click="handleDelete(record)" v-hasPermi="['sale:salein:remove']">
            <a-icon type="delete" />删除
          </a>
        </span>
      </a-table>
...
<script>
import { listSalein, delSalein, exportSalein } from '@/api/sale/salein'
...
export default {
  ...
  methods: {
    ...
    getList () {
      this.loading = true
      listSalein(this.queryParam).then(response => {
    ...
    handleExport () {
      ...
      this.$confirm({
        ...
        onOk () {
          return exportSalein(that.queryParam)
            .then(response => {
