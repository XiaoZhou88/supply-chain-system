<template>
  <a-drawer width="35%" :label-col="4" :wrapper-col="14" :visible="open" @close="onClose">
    ...
    <a-form-model ref="form" :model="form" :rules="rules">
      <a-form-model-item label="会员名称" prop="supplierName" >
        <a-input v-model="form.supplierName" placeholder="请输入会员名称" />
      </a-form-model-item>
...
<!--      <a-form-model-item label="是否系统自带" prop="isystem" >-->
...
<script>
import { getMember, addMember, updateMember } from '@/api/base/supplier'
...
export default {
  ...
  methods: {
    ...
    handleUpdate (row, ids) {
      ...
      getMember(supplierId).then(response => {
