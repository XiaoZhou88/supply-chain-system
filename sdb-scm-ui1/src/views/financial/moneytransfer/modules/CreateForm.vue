...
<script>
import { getMoneytransfer, addMoneytransfer, updateMoneytransfer } from '@/api/financial/moneytransfer'
...
export default {
  ...
  methods: {
    ...
    handleUpdate (row, ids) {
      ...
      getMoneytransfer(accountHeadId).then(response => {
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          if (this.form.accountHeadId !== undefined && this.form.accountHeadId !== null) {
            updateMoneytransfer(this.form).then(response => {
            ...
            addMoneytransfer(this.form).then(response => {
              this.$message.success(
                '新增成功',
                3
              )
